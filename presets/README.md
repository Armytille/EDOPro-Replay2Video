...
| `cpu_h264_high.ini.example` | H.264 (CPU) | No | High | Slow |
| `cpu_h265_medium.ini.example` | H.265 (CPU) | No | Medium | Slow |
| `cpu_h265_high.ini.example` | H.265 (CPU) | No | High | Very slow |
...
| `gpu_h264_nvenc_high.ini.example` | H.264 NVENC | NVIDIA | High | Very fast |
| `gpu_hevc_nvenc_medium.ini.example` | HEVC NVENC | NVIDIA GTX 10xx+ | Medium | Very fast |
| `gpu_hevc_nvenc_high.ini.example` | HEVC NVENC | NVIDIA GTX 10xx+ | High | Very fast |
| `gpu_av1_nvenc_medium.ini.example` | AV1 NVENC | NVIDIA RTX 40xx | Medium | Fast |
| `gpu_av1_nvenc_max.ini.example` | AV1 NVENC | NVIDIA RTX 40xx | Max | Fast |
